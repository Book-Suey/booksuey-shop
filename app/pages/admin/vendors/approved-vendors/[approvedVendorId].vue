...
<template>
  <section class="admin-page">
    <header class="admin-page__header">
      ...
      <div v-if="!pending && !error" class="vendor-actions">
        <button
          v-if="!isEditMode"
          type="button"
    ...
    <article v-else class="vendor-panel">
      <section class="admin-cards approved-vendor-summary-grid">
        <article class="admin-card">
          <p class="admin-card__label">Linked account</p>
          ...
          <p v-else class="panel-copy">No linked vendor account</p>
        </article>

        <article class="admin-card">
          <p class="admin-card__label">Linked account email</p>
          <p class="panel-copy">
        ...
        <article class="admin-card">
          <p class="admin-card__label">Last login</p>
          <p class="panel-copy">
        ...
        <article class="admin-card">
          <p class="admin-card__label">Imported sales</p>
        ...
        <article class="admin-card">
          <p class="admin-card__label">Imported gross</p>
          <p class="admin-card__value admin-card__value--compact">
        ...
        <article class="admin-card">
          <p class="admin-card__label">Imported commission</p>
          <p class="admin-card__value admin-card__value--compact">
            {{ formatCurrency(data.salesSummary.totalCommission) }}
          </p>
        </article>

        <article v-if="data.linkedBalance" class="admin-card">
      ...
      <form v-if="isEditMode" class="auth-form" @submit.prevent="submitUpdate">
        <label>
          <span>Basil ID</span>
    ...
    <article v-if="!pending && !error" class="vendor-panel">
      ...
      <AppDataTable
        ...
        :mobile-columns="['title', 'soldAt', 'grossAmount', 'sourceBatchId']"
      >
