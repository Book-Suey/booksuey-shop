...
<template>
  <section class="admin-page">
    <header class="admin-page__header">
      <h1 class="auth-title">Upload sales CSV</h1>
      <p class="auth-copy">
    ...
    <article class="vendor-panel stack-grid">
      ...
      <form class="auth-form" @submit.prevent="submitImport">
        <label>
    ...
    <article v-if="uploadedBatch" class="vendor-panel stack-grid">
      ...
      <template v-else>
        ...
        <div>
          ...
          <ul v-else class="compact-list">
            <li v-for="source in uploadedBatch.unmappedSources" :key="source">
              {{ source }}
            </li>
          </ul>
        </div>
