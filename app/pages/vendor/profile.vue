    ...
    <template v-else>
      ...
      <article class="vendor-panel">
        ...
        >
          ...
          <label v-if="form.preferredPayoutMethod === 'paypal'">
          ...
          <label v-else-if="form.preferredPayoutMethod === 'venmo'">
          ...
          <p
            ...
            class="panel-copy"
          >
            Select PayPal or Venmo to show the matching payout field.
          </p>
